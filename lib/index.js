...
var SSOClient = /** @class */ (function () {
    ...
    SSOClient.prototype.callback = function (req, res, redirectUri) {
        return __awaiter(this, void 0, void 0, function () {
            var options, result, user, error_1, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.oauth2) return [3 /*break*/, 8];
                        result = void 0;
                        user = void 0;
                        _a.label = 1;
                    case 1:
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, res.json("Get Token: Authentication failed")];
                    case 4:
                        _a.trys.push([4, 6, , 7]);
                    ...
                    case 6:
                        error_2 = _a.sent();
                        log.httpError(req, error_2);
                        return [2 /*return*/, res.json("Get User Info: Authentication failed")];
                    case 7:
                        try {
                            if (req.session) {
                            ...
                            return [2 /*return*/, res.json("Redirect: Authentication failed")];
                        }
                        _a.label = 8;
